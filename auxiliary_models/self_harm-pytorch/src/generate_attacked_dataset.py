...
def evaluate(eval_loader, model, args):
    ...
    for i, (images, labels) in tqdm.tqdm(enumerate(eval_loader)):
        ...
        if labels == 0:
            print("../../datasets/self_harm_attacked_2/test/non_self_harm/"+ save_name)
            torchvision.utils.save_image(images, "../../datasets/self_harm_attacked_2/test/non_self_harm/"+ save_name)
        else:
            print('../../datasets/self_harm_attacked_2/test/self_harm/'+ save_name)
            torchvision.utils.save_image(images, '../../datasets/self_harm_attacked_2/test/self_harm/'+ save_name)
