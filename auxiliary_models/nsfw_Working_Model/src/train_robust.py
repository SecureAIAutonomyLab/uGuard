...
def main(args):
    ...
    batch_size = args.batch_size
    transform_train = transforms.Compose([transforms.RandomCrop(299), transforms.ToTensor(),])


    transform_test = transforms.Compose([transforms.RandomCrop(299), transforms.ToTensor(),])
